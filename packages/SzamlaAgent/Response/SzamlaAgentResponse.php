...
namespace Packages\SzamlaAgent\Response;
...
use Packages\SzamlaAgent\Header\InvoiceHeader;
use Packages\SzamlaAgent\Log;
use Packages\SzamlaAgent\SimpleXMLExtended;
use Packages\SzamlaAgent\SzamlaAgent;
