<form wire:submit="submit">
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-10 gap-5 pl-4 pr-5">
                            <div class="col-span-5 md:col-span-2 h-28 image-fit cursor-pointer relative p-5">
                                <img class="rounded-md w-24 h-24 m-4" src="/storage/{{ $mainimage }}">
                            </div>
                            ...
                            @if ($images)
                                @foreach ($images as $key => $value)
                                    <div class="col-span-5 md:col-span-2 h-28 image-fit cursor-pointer relative p-5">
                                        ...
                                        <img class="rounded-md w-24 h-24 m-4" src="/storage/{{ $value }}">
                                        <div
                                            ...
                                            <svg wire:click="deleteImage('{{ $key }}')"
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="save-button" type="submit" id="submit">Mentés</button>
        </div>
    </div>
