<form wire:submit="submit">
                ...
                <div class="form-inline items-start flex-col xl:flex-row mt-10">
                    <div class="form-label w-full xl:w-64 xl:!mr-10">
                        <div class="text-left">
                            ...
                            <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                <div>A kép formátuma .jpg .jpeg .png.</div>
                                <div class="mt-2">Válassz olyan termékfotót, ami vonzóbbá teszi a terméket a vásárlók
                                    számára.</div>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="grid grid-cols-10 gap-5 pl-4 pr-5">
                            <div class="col-span-5 md:col-span-2 h-28 relative image-fit cursor-pointer">
                                @if ($mainimage)
                                    <img class="rounded-md" src="{{ $mainimage->temporaryUrl() }}">
                                    <div
                                ...
                                @endif
                                <input type="file" wire:model="mainimage">
                                @error('mainimage')
                            ...
                            @if ($photos)
                                @foreach ($photos as $key => $value)
                                    <div class="col-span-5 md:col-span-2 h-28 relative image-fit">
                                        ...
                                        <img class="rounded-md" src="{{ $value->temporaryUrl() }}">
                                        <div
            ...
            <div class="mt-5">
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        ...
                        <div class="form-help text-right">Karakterszám {{ $product_name_lenght }}/25</div>
                    </div>
                </div>
                ...
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        ...
                        <input wire:model.blur="battery" id="battery" type="number" step="1"
                            min="0" max="100" class="form-control"
                            placeholder="Akkumulátor töltöttsége (ha releváns)">
                    </div>
                </div>

                <div class="mt-5">
                    @include('livewire.admin.product.products.partials.add-product-type-loop')
                </div>
                ...
                <div class=" mt-5">
                    @include('livewire.admin.product.products.partials.add-product-editor')
                </div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="btn btn-success py-2 px-4 mr-2 text-white w-full" type="submit"
                id="submit">Mentés</button>
        </div>
    </div>
