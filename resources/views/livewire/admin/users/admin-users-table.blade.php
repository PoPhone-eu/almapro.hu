                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr wire:key="user-{{ $user->id }}" class="intro-x">
                            <td>
                                <span class="font-medium whitespace-nowrap">{{ $user->full_name }}</span>
                            </td>
                            <td>
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <button class="flex items-center mr-3"
                                        @click="$dispatch('open-admin-modal-edit', { admin_id: {{ $user->id }}} )"
                                    ...
                                    <button
                                        ...
                                        class="flex items-center text-danger" role="button"> <svg
