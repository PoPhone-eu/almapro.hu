<div x-data="{ show: false }" x-show="show" x-on:open-admin-modal.window="show = true"
    ...
    style="margin-top: 0px; margin-left: 0px; padding-left: 0px; z-index: 10000;" x-transition.duration>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    @if ($admin == null)
                        ...
                        <input type="password" wire:model="password"
                            class="w-full outline-none rounded bg-gray-100 p-2 mt-2 mb-3" autocomplete="off" required />
                    @endif
                </div>
