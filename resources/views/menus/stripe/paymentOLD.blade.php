...
@section('maincontent')
    ...
    @php
        $user_points = getUserPoints(auth()->user()->id);
    @endphp
    ...
    <div class="profile-content">
        ...
        <form method="post" action="/stripesubmit" class="row">
            ...
            <div class="form-container">
                ...
                <div class="">
                    <input type="button" id="card-button" value="FIZETÉS" class="stripe-btn">
                </div>
            </div>
        ...
        <script>
            const stripe = Stripe('pk_test_fPDNEm6aaYxpFnw32jYdfdOk00nXsIofsz');
            ...
            cardButton.addEventListener('click', async (e) => {
                ...
                if (error) {} else {
                    ...
                    // got to stripe.submit with response data with axios
                    axios.post('/stripesubmit', {
