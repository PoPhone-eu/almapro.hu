...
<div x-cloak x-data="{ showorder: false }" x-show="showorder" x-on:open-admin-order-modal.window="showorder = true"
    x-on:close-modal.window="showorder = false" x-on:keydown.escape.window="showorder = false"
